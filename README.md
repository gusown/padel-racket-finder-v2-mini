...
Alle Schläger, ihre technischen Daten (Form, Gewicht, Balance, Kernhärte, Spielniveau), Testwerte (Power, Kontrolle, Komfort, Handling, Effet, Fehlertoleranz — jeweils 0–10) und Produktbilder stammen von **[padelreference.com](https://www.padelreference.com)**, Stand September 2026. Zwei Werte (Netzspiel, Defensive) gibt es dort nicht direkt — die leiten wir rechnerisch aus den vorhandenen Testwerten ab. Damit die Seite auch auf dem Handy schnell lädt, werden die Produktfotos (im Original bis zu 2000 px / 1 MB) als kleine, zwischengespeicherte Vorschaubilder über [images.weserv.nl](https://images.weserv.nl) geladen (Ø ca. 16 KB statt mehrerer hundert KB). Klappt das nicht, lädt die App automatisch das Originalbild vom Shop; erst wenn auch das scheitert, erscheint ein Platzhalter-Icon.
